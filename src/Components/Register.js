...
const Register = () => {
  ...
  return (
    <div className="bg-base-100">
        <div class="h-full md:h-screen my-8 lg:my-0 container flex justify-center items-center">
      <div class="w-full  md:w-[50%] lg:w-[33%]">
        <div class="pb-6 px-6 md:px-10  bg-accent rounded-xl mt-8 mb-4">
        <h1 className="text-center text-3xl font-semibold pt-4 pb-2 uppercase text-secondary">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div class="form-control w-full max-w-xs">
              ...
              {...register("option",{required:"Identity Required"})}
              >
